...
#define HYPERPLATFORM_PERFCOUNTER_P_JOIN2(x, y) x##y		// 这个宏是在 MYHYPERPLATFORM_PERFCOUNTER_MEASURE_TIME 宏中用来构造变量名用的
#define HYPERPLATFORM_PERFCOUNTER_P_JOIN1(x, y) \
	HYPERPLATFORM_PERFCOUNTER_P_JOIN2(x, y)

#define HYPERPLATFORM_PERFCOUNTER_P_JOIN(x, y) \			// 实际构造调用宏
